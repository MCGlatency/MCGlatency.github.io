...
void SurfaceFlinger::onMessageInvalidate(int64_t vsyncId, nsecs_t expectedVSyncTime) {
    ...
    ALOGI("SurfaceFinger onMessageInvalidate: time = %" PRId64, frameStart);
    ...
    ALOGI("SurfaceFlinger onMessageInvalidate: INVALIDATE over, REFRESH start. time: %" PRId64, systemTime());
...
void SurfaceFlinger::onMessageRefresh() {
    ...
    ALOGI("SurfaceFlinger onMessageRefresh: mFrameStartTime: %" PRId64, mFrameStartTime);
    ALOGI("SurfaceFlinger onMessageRefresh: Display Refreshed. time: %" PRId64, systemTime());
