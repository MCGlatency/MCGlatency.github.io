...
EGLBoolean eglSwapBuffers(EGLDisplay dpy, EGLSurface surface) {
    ...
    egl_connection_t* const cnx = &gEGLImpl;
    ALOGI("EGL eglApi.cpp call eglSwapBuffers, block time: %" PRId64, systemTime());
    EGLBoolean ret = cnx->platform.eglSwapBuffers(dpy, surface);
    ALOGI("EGL eglApi.cpp call eglSwapBuffers, release time: %" PRId64, systemTime());
    return ret;
}
