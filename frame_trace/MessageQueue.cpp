...
void MessageQueue::vsyncCallback(nsecs_t vsyncTime, nsecs_t targetWakeupTime, nsecs_t readyTime) {
...

    {
        ...
        ALOGI("SurfaceFinger MessageQueue vsyncCallback 1: old lastCallbackTime = %" PRId64, (nsecs_t)mVsync.lastCallbackTime.count());
        mVsync.lastCallbackTime = std::chrono::nanoseconds(vsyncTime);
        mVsync.scheduled = false;
        ALOGI("SurfaceFinger MessageQueue vsyncCallback 2: new lastCallbackTime = %" PRId64, (nsecs_t)mVsync.lastCallbackTime.count());
    }
...
void MessageQueue::invalidate() {
    ...
    ALOGI("SurfaceFinger MessageQueue invalidate: call registration->schedule: lastCallbackTime = %" PRId64 ", currentTime = %" PRId64, (nsecs_t)mVsync.lastCallbackTime.count(), systemTime());
